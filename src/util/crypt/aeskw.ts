...
export default class AESKW {
    ...
    static decrypt(aesVersion: 128 | 192 | 256, encrypted: Buffer, key: CipherKey): Buffer {
        const decipher = createDecipheriv(`id-aes${aesVersion}-wrap`, key, Buffer.alloc(8, 0xa6));
